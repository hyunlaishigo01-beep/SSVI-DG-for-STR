function [Fw,Fw_fake,FW,Falpha,Fb,X_1,norm_fix] = part5_dvi_STR(Xtrain,Ytrain, tensorSize, prev_w, prev_w_fake,STRmax_iter, STRtol_error, dcdm_Max_ite, C1, C2, g,prev_X,prev_norm,prev_d1,eps)


w_norm = sqrt(prev_w_fake{1,1}*prev_w_fake{1,1}');
it1=prev_X*prev_w_fake{1,1}'/C1;
item1=(0.5*(C2+C1)*it1);
